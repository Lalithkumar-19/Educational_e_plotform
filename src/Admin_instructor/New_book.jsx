...
function New_book() {
    ...
    const handle_create = async () => {
        if (
            ...
            await fetch("http://localhost:5000/addnew_book?token="+localStorage.getItem("instructor-token"), {
                method: "POST",
                body: data,
            }).then((succ) => {
                console.log(succ);
    ...
    return (
        <div className='new_book'>
            ...
            <form>
                ...
                <button className='create-a-book' type='button' id='button' onClick={handle_create}>Create Product</button>
