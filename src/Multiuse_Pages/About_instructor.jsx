...
function About_instructor() {
    ...
    const Fetch_Instructor_data = async () => {
        try {
            const res = await axios.get("http://localhost:5000/fetch_one_ins?id=" + params.id);
            if (res.status === 200) {
                setData(res.data)
            }
        } catch (error) {
                        ...
                        <section className="about_instructor_left">
                            ...
                            <div className="about_instructor_card">
                                <div className="instructor_pic">
                                    <img src={"http://localhost:5000/" + data.instructor_pic} width={"100%"} style={{ borderRadius: "20px" }} height={"100%"} alt="instructor_profile" />
                                </div>
