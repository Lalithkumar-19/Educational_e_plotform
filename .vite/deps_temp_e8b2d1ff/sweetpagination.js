...
// vite:dep-pre-bundle:external-conversion:C:/Users/LALITH KUMAR/Education_website/node_modules/sweetpagination/Components/SweetPagination.css
var SweetPagination_exports = {};
import "C:/Users/LALITH KUMAR/Education_website/node_modules/sweetpagination/Components/SweetPagination.css";
var init_SweetPagination = __esm({
  "vite:dep-pre-bundle:external-conversion:C:/Users/LALITH KUMAR/Education_website/node_modules/sweetpagination/Components/SweetPagination.css"() {
  }
});

// node_modules/sweetpagination/index.js
var require_sweetpagination = __commonJS({
  "node_modules/sweetpagination/index.js"(exports) {
    ...
    var SweetPagination = function SweetPagination2(_ref) {
      var dataPerPage = _ref.dataPerPage, getData = _ref.getData, currentPageData = _ref.currentPageData, navigation = _ref.navigation, getStyle = _ref.getStyle;
      var pageNumbers = [];
      var showPagination = [];
      var _useState = (0, _react.useState)(1), _useState2 = _slicedToArray(_useState, 2), currentPage = _useState2[0], setCurrentPage = _useState2[1];
      var _useState3 = (0, _react.useState)(), _useState4 = _slicedToArray(_useState3, 2), dataPerPageState = _useState4[0], setDataPerPageState = _useState4[1];
      var _useState5 = (0, _react.useState)(false), _useState6 = _slicedToArray(_useState5, 2), navigationState = _useState6[0], setNavigationState = _useState6[1];
      var _useState7 = (0, _react.useState)([1, 2, 3, 4, 5]), _useState8 = _slicedToArray(_useState7, 2), showPaginationState = _useState8[0], setShowPaginationState = _useState8[1];
      var _useState9 = (0, _react.useState)(""), _useState10 = _slicedToArray(_useState9, 2), style = _useState10[0], setStyle = _useState10[1];
      var _useState11 = (0, _react.useState)(""), _useState12 = _slicedToArray(_useState11, 2), styleCustom = _useState12[0], setStyleCustom = _useState12[1];
      var _useState13 = (0, _react.useState)([1, 2, 3, 4, 5]), _useState14 = _slicedToArray(_useState13, 2), newPageData = _useState14[0], setNewPageData = _useState14[1];
      ...
      var handleCurrentPage = function handleCurrentPage2(pageNumber) {
        setCurrentPage(pageNumber);
      };
      var handleDirectFirstPage = function handleDirectFirstPage2() {
        setShowPaginationState([1, 2, 3, 4, 5]);
      };
      var handleDirectLastPage = function handleDirectLastPage2() {
      ...
      if (pageNumbers.length > 10) {
        return _react["default"].createElement("nav", {
        ...
        }, navigationState && (currentPage === 1 ? _react["default"].createElement("li", {
          className: "pageItem"
          ...
          d: "M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z"
        }))))), showPaginationState.at(0) > pageNumbers.at(0) && _react["default"].createElement(_react.Fragment, null, _react["default"].createElement("li", {
          className: "pageItem"
        }, _react["default"].createElement("button", {
          onClick: function onClick() {
        ...
        }, pageNumbers.at(0))), _react["default"].createElement("li", {
          className: "pageItem"
        }, _react["default"].createElement("button", {
        ...
        }), showPaginationState.at(-1) < pageNumbers.at(-1) && _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("li", {
          className: "pageItem"
        }, _react["default"].createElement("button", {
          className: "pageButton commonButtonStyle"
        }, _react["default"].createElement("svg", {
        ...
        }, pageNumbers.at(-1)))), navigationState && (currentPage === pageNumbers.at(-1) ? _react["default"].createElement("li", {
          className: "pageItem"
        }, _react["default"].createElement("button", {
...
export default require_sweetpagination();
//# sourceMappingURL=sweetpagination.js.map
